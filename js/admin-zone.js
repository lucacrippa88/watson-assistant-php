...
/*
 * Function: getURLParameter Â©
 * Returns: get the parameter corresponding to the selected name
 * Author: Luca Crippa - luca.crippa88@gmail.com
 * Date: June 2017
 */
...
/*
 * Function: showPassword Â©
 * Returns: mostra la password se l'icona show password Ã¨ cliccata
 * Author: Luca Crippa - luca.crippa88@gmail.com
 * Date: January 2018
 */
...
/*
* Function: initSelect Â©
* Returns: inizializzazione dei select di materialize.css
* Author: Luca Crippa - luca.crippa88@gmail.com
* Date: July 2017
*/
function initSelect(){
...
/*
* Function: initDatetime Â©
* Returns: inizializzazione dei datepicker e timepicker di materialize.css
* Author: Luca Crippa - luca.crippa88@gmail.com
* Date: July 2017
*/
function initDatetime(){
 // initialize datepicker (http://amsul.ca/pickadate.js/date/)
 $('.datepicker').pickadate({
	 ...
	 onClose: function(){ // prevent reopening after tab change
			 $(document.activeElement).blur()
	 }
 });
 // initialize timepicker (http://amsul.ca/pickadate.js/time/)
 $('.timepicker').pickatime({
		default: 'now', // Set default time
		fromnow: 0,       // set default time to * milliseconds from now (using with default = 'now')
		twelvehour: false, // Use AM/PM or 24-hour format
		donetext: 'OK', // text for done-button
		cleartext: 'Annulla', // text for clear-button
		canceltext: 'Chiudi', // Text for cancel-button
